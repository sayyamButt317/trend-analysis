...
from service.Outreach.linkedin_toast import ReadLinkedinToast, ToastIsResendCoolDown
...
from service.Outreach.send_note import FillAndSendNote
from service.Outreach.trigger.trigger_connect import TriggerConnect
from service.Outreach.visible_button import ListVisibleActionButtons


async def send_connection_request(page: Page, *, note: str | None = None) -> dict[str, Any]:
