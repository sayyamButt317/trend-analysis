...
async def AnalyzeUserInstaNode(state: CompetitorState) -> CompetitorState:
    ...
    merge_company_analysis(
        state,
        {
            ...
            "detected_category": analysis.get(
    ...
    state["discovery_features"] = {
        "industry": analysis.get("detected_niche"),
        "keywords": analysis.get("keywords") or [],
        "services": analysis.get("services") or [],
        "hashtags": analysis.get("top_hashtags") or [],
        "content_categories": analysis.get("content_categories") or [],
        "content_themes": analysis.get("content_themes") or [],
